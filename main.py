...
try:
    with sr.Microphone() as source:
        ...
        if command_list[0] == 'Angela':
            ...
            if command_list[1:4] == ['add', 'an', 'event'] or command_list[1:4] == ['add', 'a', 'event'] or command_list[1:4] == ['add', 'to', 'calendar']:
                print(command)
            ...
            elif command_list[1:4] == ['schedule', 'a', 'meeting']:
